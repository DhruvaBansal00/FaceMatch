...
from utils.rand_class import get_class
...
target_emo = get_class()
# plt.figure(1)
# plt.imshow(mpimg.imread(base_path+'/' + str(target_emo) + '.jpg'))
# plt.figure(2)
image_path = base_path+'/' + str(target_emo) + '.jpg'
# loading images
...
for face_coordinates in faces:
    ...
    emotion_text = emotion_labels[target_emo] + '- '+ str(round(emotion_label_arg*100, 2))
    print(target_emo)
    print(emotion_text)
